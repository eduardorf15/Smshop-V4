export function buildImportedProduct({
  ...
  const product = {
    ...
    syncStatus: data.syncMethod === "official-api" ? "official-api" : syncStatus,
    dataSource: data.syncMethod === "official-api" ? "official-api" : syncStatus === "synced" ? dataSource(data.source, data.type) : "mercadolivre-partial",
    meliId,
